...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 14, 2023 at 07:02 PM
...
(76, 'Badshah', 'Heartless [ Slowed + Reverb ]', '4:52', '../admin/upload/Heartless - Badshah (Slowed+Reverb).mp3'),
(77, 'Badshah', 'Dj Waley Babu (Slowed + Reverbed)', '3:14', '../admin/upload/Dj Waley Babu (Slowed + Reverbed).mp3'),
(78, 'Badshah', 'Tareefan [Slowed+Reverb]', '3:02', '../admin/upload/Tareefan [Slowed+Reverb].mp3'),
(79, 'Badshah', 'Mercy (slowed+reverb)', '3:03', '../admin/upload/Mercy (slowed+reverb).mp3');
