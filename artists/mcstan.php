...
<body>
    <div class="player">
        <div class="audio-container">
            <center><img border="0" height="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQG8wN_xDymQ_fiLqPPUNpIRI-fVaWn--9YqA&usqp=CAU" /></center>
        ...
        <div class="playlist">
            <ul id="playlist-items">
                ...
                $sql = "SELECT * FROM music where artist_name='Mc Stan'";
