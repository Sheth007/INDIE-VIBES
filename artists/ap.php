...
<body>
    <div class="player">
        <div class="audio-container">
            <center><img border="0" height="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_L06gzXP-6cYMaaRDq2ur0qrDsv_6svKjXtdVdz2jtYd10LlNmz8_nH9hPPf-6rKXvbQ&usqp=CAU" /></center>
        ...
        <div class="playlist">
            <ul id="playlist-items">
                ...
                $sql = "SELECT * FROM music where artist_name='Ap Dhillion'";
