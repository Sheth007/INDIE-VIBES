...
<body>
    <div class="player">
        <div class="audio-container">
            <center><img border="0" height="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTYQhxz8Qmkcjd8k8HYIVwaGbMYlD1TUemk1A&usqp=CAU" /></center>
        ...
        <div class="playlist">
            <ul id="playlist-items">
                <!-- Fetch and display music items dynamically using PHP -->
                <?php
